...
Nuts.prototype.onUpdateWin = function(req, res, next) {
    ...
    console.log("onUpdateWin:", fullUrl);
    ...
    .then(function(versions) {
        // Update needed?
        console.log("onUpdateWin versions:", versions);
        ...
        var asset = _.find(latest.platforms, {
            filename: (platform == "windows_64" ? "RELEASES_64" : "RELEASES_32")
        });
       ...
       .then(function(content) {
            ...
            console.log("onUpdateWin releases:", releases);
            ...
            console.log("onUpdateWin output:", output);
