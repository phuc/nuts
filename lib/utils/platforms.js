...
function detectPlatform(platform) {
    ...
    if (name == 'releases_32' || (hasSuffix(name, '.nupkg') && _.contains(name, 'ia32'))) return platforms.WINDOWS_32;
    if (name == 'releases_64' || (hasSuffix(name, '.nupkg') && _.contains(name, 'x64'))) return platforms.WINDOWS_64;
